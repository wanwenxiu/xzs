...
public class DialogManager {
    ...
    public void recording() {
        if (mDialog != null && mDialog.isShowing()) {
            ...
            imgBg.setBackgroundResource(R.mipmap.ic_voice_1);
    ...
    public void wantToCancel() {
        if (mDialog != null && mDialog.isShowing()) {
            ...
            imgBg2.setBackgroundResource(R.mipmap.ic_voice_cancel);
    ...
    public void tooShort() {
        if (mDialog != null && mDialog.isShowing()) {
            ...
            imgBg.setVisibility(View.GONE);
            tipsTxt.setVisibility(View.GONE);
            imgBg2.setBackgroundResource(R.mipmap.ic_voice_sigh);
    ...
    public void updateVoiceLevel(int level) {
        ...
        if (mDialog != null && mDialog.isShowing()) {
            ...
            int resId = mContext.getResources().getIdentifier("ic_voice_" + level,
